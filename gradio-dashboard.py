...
def retrieve_sematic_recommendations(
    ...
    # Sort based on selected emotional tone
    if tone == "Happy":
...
with gr.Blocks(theme=gr.themes.Glass()) as dashboard:
    ...
    with gr.Row():
        user_query = gr.Textbox(label="Please enter a description of a book you'd like to read:",
...
"""
I created a vector database that also the user to find the most similar books to a query
I used text classification to sort the books into fiction and non-fiction
